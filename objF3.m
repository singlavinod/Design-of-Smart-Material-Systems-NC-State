...
% Element 3
U1diff65 = (sqrt(2/(rho_b*L_b*A_b)))*(1*pi/L_b)*(cos((1*pi*X(6))/L_b)-cos((1*pi*X(5))/L_b));
U2diff65 = (sqrt(2/(rho_b*L_b*A_b)))*(2*pi/L_b)*(cos((2*pi*X(6))/L_b)-cos((2*pi*X(5))/L_b));
U3diff65 = (sqrt(2/(rho_b*L_b*A_b)))*(3*pi/L_b)*(cos((3*pi*X(6))/L_b)-cos((3*pi*X(5))/L_b));
U4diff65 = (sqrt(2/(rho_b*L_b*A_b)))*(4*pi/L_b)*(cos((4*pi*X(6))/L_b)-cos((4*pi*X(5))/L_b));

%% Open loop matrices
B_ = Ka.*[U1diff21,U1diff43,U1diff65;...
...
C_ = [Ks1.*[U1diff21,U2diff21,U3diff21,U4diff21];...
    ...
    Ks3.*[U1diff65,U2diff65,U3diff65,U4diff65]];
